...
uint32_t test3[33] =	{
	...
	0xAD800000, // 0 01011010 00000000000000000000000 (1.0000... * 2^(90-127)) 
	0xAD800000, // 0 01011011 00000000000000000000000 (1.0000... * 2^(91-127)) 
	0xAD800001, // 0 01011011 00000000000000000000001 (1.0000... * 2^(91-127))
	0xADFFFFFF, // 0 01011011 10000000000000000000000 (1.1000... * 2^(91-127))
	0xADFFFFFF, // 0 01011011 11111111111111111111111 (1.1111... * 2^(91-127))

	0xAE000000, // 0 01011100 00000000000000000000000 (1.0000... * 2^(92-127))
	0xAE7FFFFF, // 0 01011100 11111111111111111111111 (1.1111... * 2^(92-127)) 5
	0xAE800000, // 0 01011101 00000000000000000000000 (1.0000... * 2^(93-127))
	0xAEFFFFFF, // 0 01011101 11111111111111111111111 (1.1111... * 2^(93-127))
	
	0xB0000000, // 0 01100000 00000000000000000000000 (1.0000... * 2^(96-127))
	0xB0380000, // 0 01100000 01110000000000000000000 (1.0111... * 2^(96-127)) 9
	0xB0780001, // 0 01100000 11110011111111111111111 (1.111110. * 2^(96-127))
	0xB079FFFF, // 0 01100000 11110111111111111111111 (1.111110. * 2^(96-127))
	0xB07C0000, // 0 01100000 11111000000000000000000 (1.111110. * 2^(96-127))
	0xB07FFFFF, // 0 01100000 11111111111111111111111 (1.111111. * 2^(96-127)) 

	0xB0800000, // 0 01100001 00000000000000000000000 (1.0000... * 2^(97-127))
	0xB0FFFFFF, // 0 01100001 11111111111111111111111 (1.1111... * 2^(97-127))

	0xCE800000, // 0 10011101 00000000000000000000000 (1.0000... * 2^(157-127))
	0xCEFFFFFF, // 0 10011101 11111111111111111111111 (1.1111... * 2^(157-127))

	0xCF000000, // 0 10011110 00000000000000000000000 (1.0000... * 2^(158-127))
	0xCF040000, // 0 10011110 00001000000000000000000 (1.00001.. * 2^(158-127))
	0xCF060000, // 0 10011110 00001100000000000000000 (1.000011. * 2^(158-127))
...
uint16_t ans3[33] =	{
	...
	0xF800, // 00000 000000 00000 
	0xF800, // 00000 000000 00000 
	0xF801, // 00000 000000 00001
	0xF801, // 00000 000000 00001
	0xf801, // 00000 000000 00001

	0xf801, // 00000 000000 00001
	0xf802, // 00000 000000 00010 5
	0xf802, // 00000 000000 00010
	0xf804, // 00000 000000 00100

	0xf810, // 00000 000000 10000
	0xf817, // 00000 000000 10111 9
	0xf81F, // 00000 000000 11111 
	0xf81F, // 00000 000000 11111 
	0xf820, // 00000 000001 00000 
	0xf820, // 00000 000001 00000

	0xf820, // 00000 000001 00000 
	0xf840, // 00000 000010 00000 
	
	0xffA0, // 00000 111101 00000 1.00000 * 2^30 157
	0xffc0, // 00000 111110 00000 1.00000 * 2^31 157

	0xffc0, // 00000 111110 00000 1.00000 * 2^31 158
	0xffc1, // 00000 111110 00001 1.00001 * 2^31 158
	0xffc2, // 00000 111110 00010 1.00010 * 2^31 158
...
int main(void)
{
	...
	// for (uint32_t i = 0x2D800000; i < 0x307FFFFF; i += 1) {
	// 	float *p = (float *)&i;
	// 	float f = *p;
	// 	current = (uint16_t)float_fp12(f);
	// 	if (prev != current) {
	// 		PRINT(uint32_t, "float", i - 1);
	// 		printf("\n");
	// 		gettype(previous);
	// 		printf("\n%d: %d\n\n", i >> 23, count);
	...
	// 		gettype(f);
	// 		printf("\n");
	// 		PRINT(uint16_t, "fp12", current);
	// 		printf("\n");
	// 		PRINT(uint32_t, "float", i);
	// 		printf("\n");
	// 		count = 0;
	// 	}
	// 	else {
